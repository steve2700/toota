...
urlpatterns = [
    ...
    path('drivers/', views.DriverListView.as_view(), name='all-drivers'),
    ...
    path('driver/verification-check/<id>/', views.CheckDriverVerification.as_view(), name='driver_document-check'),
