...
from .views import TripListCreateView, TripRetrieveUpdateDeleteView, TripRetrieveByDriverView, TripListView, TripCompletedCountView, PaymentListCreateAPIView, PaymentRetrieveUpdateDestroyAPIView, DriverAcceptanceRateView
...
urlpatterns = [
    ...
    path('driver/<int:pk>/acceptance_rate/', DriverAcceptanceRateView.as_view(), name='driver-acceptance-rate'),
]
