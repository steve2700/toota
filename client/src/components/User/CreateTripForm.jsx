    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            if (error.response && error.response.status === 400) {
                ...
                setErrors(data); // Capture field-specific validation errors
            } else {
                                ...
                                >
                                    <input
                                        ...
                                        className={`shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline ${
                                            errors['pickup_location.location']
                                                ? 'border-red-500'
                                                : ''
                                        }`}
                                        required
                        ...
                        <div>
                            ...
                            <div className="mb-4">
                                ...
                                >
                                    <input
                                        ...
                                        className={`shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline ${
                                            errors['dropoff_location.location']
                                                ? 'border-red-500'
                                                : ''
                                        }`}
                                        required
                            ...
                            <div className="mb-4">
                                ...
                                <input
                                    ...
                                    className={`shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline ${
                                        errors['dropoff_location.phone_number']
                                            ? 'border-red-500'
                                            : ''
                                    }`}
                                    required
