...
const BecomeDriver = () => {
  return (
    <div>
      <Header />
      <section className="become-driver shadow-md rounded overflow-hidden p-6">
        ...
        <div className="benefits p-8 bg-gray-100 rounded">
          <h3 className="text-2xl font-bold mb-6 text-[#f89f1b]">BENEFITS</h3>
          <div className="flex flex-wrap justify-center items-center gap-4">
            <div className="benefit w-full sm:w-1/2 md:w-1/3 lg:w-1/4 mb-4 text-center">
              <div className="flex items-center justify-center mb-2">
                <MdOutlineAttachMoney className="text-[#f89f1b] text-2xl mr-2" />
            ...
            <div className="benefit w-full sm:w-1/2 md:w-1/3 lg:w-1/4 mb-4 text-center">
              <div className="flex items-center justify-center mb-2">
                <RiTimeLine className="text-[#f89f1b] text-2xl mr-2" />
            ...
            <div className="benefit w-full sm:w-1/2 md:w-1/3 lg:w-1/4 mb-4 text-center">
              <div className="flex items-center justify-center mb-2">
                <FaHandshake className="text-[#f89f1b] text-2xl mr-2" />
            ...
            <div className="benefit w-full sm:w-1/2 md:w-1/3 lg:w-1/4 mb-4 text-center">
              <div className="flex items-center justify-center mb-2">
                <RiRoadMapLine className="text-[#f89f1b] text-2xl mr-2" />
        ...
        <div className="join-toota p-8 bg-[#404042] text-white rounded mt-6">
          ...
          <Link to="/signup/driver">
            <button className="bg-[#f89f1b] text-black px-6 py-3 rounded hover:bg-gray-200 focus:outline-none">
              Apply Now
            </button>
          </Link>
        </div>
